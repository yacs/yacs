...
class Messages {
	...
	public static function submit_file($entity_headers, $content, $user, $anchor, $target=NULL) {
		...
		$item['edit_date'] = gmdate('Y-m-d H:i:s', time());
	...
	public static function submit_page($entity_headers, $text, $user, $anchor=NULL, $target=NULL) {
		...
		$entry_fields['create_date'] = gmdate('Y-m-d H:i:s', strtotime($context['mail_date']));
		...
		$entry_fields['edit_date'] = gmdate('Y-m-d H:i:s', time());
		...
		// create a new page
			...
			if((isset($context['users_with_auto_publish']) && ($context['users_with_auto_publish'] == 'Y'))
				...
				$entry_fields['publish_date'] = gmdate('Y-m-d H:i:s', time());
