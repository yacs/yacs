...
// current item
if(isset($item['id']))
	$context['current_item'] = 'action:'.$item['id'];
...
} elseif($context['self_url'] && ($canonical = $context['url_to_home'].$context['url_to_root'].Actions::get_url($item['id'])) && strncmp($context['self_url'], $canonical, strlen($canonical))) {
