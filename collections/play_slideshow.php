	...
	// built the slideshow
		...
		// do the show
			...
			$context['text'] .= JS_PREFIX
				...
				.'var handle = $(\'#slide_\'+current)[0]'."\n"
				.'if(handle)'."\n"
				.'	handle.style.display = \'block\';'."\n"
				."\n"
				.'// update index of slides'."\n"
				.'if(handle = $("#slide_list")[0])'."\n"
				...
				.'	var previous = $(\'#slide_\'+current);'."\n"
				.'	if(previous)'."\n"
				.'		previous.style.display = \'none\';'."\n"
				."\n"
				.'	// show selected slide'."\n"
				.'	current = handle.selectedIndex;'."\n"
				.'	if(handle = $(\'#slide_\'+current)[0])'."\n"
				.'		handle.style.display = \'block\';'."\n"
				.'}'."\n"
				."\n"
				...
				.'		if(handle = $(\'#first_button\')[0])'."\n"
				.'			handle.disabled = false;'."\n"
				.'		if(handle = $(\'#previous_button\')[0])'."\n"
				.'			handle.disabled = false;'."\n"
				.'		if(handle = $(\'#next_button\')[0])'."\n"
				.'			handle.disabled = false;'."\n"
				.'		if(handle = $(\'#last_button\')[0])'."\n"
				.'			handle.disabled = false;'."\n"
				."\n"
				.'	// start the slideshow'."\n"
				.'	} else {'."\n"
