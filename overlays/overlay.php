...
class Overlay {
	 ...
	 */
	final public function load_scripts($myclass='') {
	    ...
	    Js_css::link_script('overlays/'.$myclass.'/'.$myclass.'.css');
	    Js_css::link_script('overlays/'.$myclass.'/'.$myclass.'.js');
