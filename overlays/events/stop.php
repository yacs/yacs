...
// no overlay
} elseif(!is_object($overlay) || !is_callable(array($overlay, 'get_stop_url')))
	Logger::error(i18n::s('You are not allowed to perform this operation.'));
...
// get the address to stop and to leave the meeting
elseif(!$follow_up = $overlay->get_stop_url())
	Logger::error(i18n::s('You are not allowed to perform this operation.'));
