...
// get the input parameters
	...
	$context['text'] .= '<script type="text/javascript">// <![CDATA['."\n"
		...
		.'document.getElementById("reference_server").focus();'."\n"
		.'// ]]></script>'."\n";
...
// save updated parameters
	...
	if(!Safe::file_put_contents('parameters/scripts.include.php', $content)) {
		...
		Skin::error(sprintf(i18n::s('ERROR: Impossible to write to the file %s. The configuration has not been saved.'), 'parameters/scripts.include.php'));
