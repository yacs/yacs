<?php
/**
 * update javascript libraries and dewplayer
 *
...
// splash message
global $local;
$local['label_en'] = 'Update javascript libraries and dewplayer';
$local['label_fr'] = 'Mise &agrave; jour de librairies javascript et de dewplayer';
...
unset($files);
$files[] = 'codes/edit.js';
$files[] = 'included/browser/dewplayer.swf';
