...
// splash message
global $local;
$local['label_en'] = 'Install jscolor';
$local['label_fr'] = 'Installation de jscolor';
...
unset($files);
$files[] = 'included/jscolor/arrow.gif';
$files[] = 'included/jscolor/cross.gif';
$files[] = 'included/jscolor/hs.png';
$files[] = 'included/jscolor/hv.png';
$files[] = 'included/jscolor/jscolor.js';
