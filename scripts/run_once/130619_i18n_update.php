...
// splash message
global $local;
$local['label_en'] = 'Update localisation files';
$local['label_fr'] = 'Mise à jour des fichiers de localisation';
...
$files[] = 'i18n/locale/en/canvas.mo';
...
$files[] = 'i18n/locale/fr/canvas.mo';
