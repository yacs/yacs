...
// splash message
$local['label_en'] = 'Update smileys';
$local['label_fr'] = 'Mise &agrave; jour des emoticons';
...
$files[] = 'smileys/images/cake.gif';
$files[] = 'smileys/images/camera.gif';
$files[] = 'smileys/images/cat.gif';
$files[] = 'smileys/images/clock.gif';
$files[] = 'smileys/images/cocktail.gif';
$files[] = 'smileys/images/cup.gif';
$files[] = 'smileys/images/dog.gif';
$files[] = 'smileys/images/email.gif';
$files[] = 'smileys/images/film.gif';
$files[] = 'smileys/images/note.gif';
$files[] = 'smileys/images/phone.gif';
$files[] = 'smileys/images/present.gif';
$files[] = 'smileys/images/rose.gif';
$files[] = 'smileys/images/unlove.gif';
