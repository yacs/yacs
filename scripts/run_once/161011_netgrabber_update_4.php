...
/**
 * Update files netgrabber alpha #4 to #5
 *
...
// splash message
global $local;
$local['label_en'] = 'Upgrade from Netgrabber alpha #4 to #5';
$local['label_fr'] = 'Mise à jour de Netgrabber alpha #4 to #5';
...
$copy[] = 'skins/mu/favicon32.png';
$copy[] = 'skins/mu/mu.less';
$copy[] = 'skins/mu/preview.jpg';
