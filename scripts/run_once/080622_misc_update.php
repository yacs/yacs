...
$local['label_fr'] = 'Mise &agrave; jour vari&eacute;es';
...
$files = array();
$files[] = 'readme.txt';
$files[] = 'articles/article.css';
$files[] = 'included/jscalendar/calendar.js.jsmin';
$files[] = 'included/jscalendar/calendar-setup.js.jsmin';
...
$files[] = 'temporary/cache_included_jscalendar_minify-en.js';
$files[] = 'temporary/cache_included_jscalendar_minify-fr.js';
$files[] = 'tools/build_i18n.bat';
$files[] = 'tools/build_i18n.sh';
$files[] = 'tools/check_i18n.bat';
$files[] = 'tools/check_i18n.sh';
$files[] = 'tools/srcfiles.txt';
$files[] = 'tools/update_i18n.bat';
$files[] = 'tools/update_i18n.sh';
$files[] = 'tools/yacs_crontab';
