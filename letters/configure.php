...
$context['page_title'] = sprintf(i18n::s('%s: %s'), i18n::s('Configure'), i18n::s('Newsletters'));
...
// save updated parameters
	...
	if(!Safe::file_put_contents('parameters/letters.include.php', $content)) {
		...
		Logger::error(sprintf(i18n::s('ERROR: Impossible to write to the file %s. The configuration has not been saved.'), 'parameters/letters.include.php'));
