...
class getID3
{
	...
	function getID3()
	{
		...
		if (GETID3_OS_ISWINDOWS && !defined('GETID3_HELPERAPPSDIR')) {
			...
			} elseif (strpos(Safe::realpath($helperappsdir), ' ') !== false) {

				$DirPieces = explode(GETID3_OS_DIRSLASH, Safe::realpath($helperappsdir));
			...
			define('GETID3_HELPERAPPSDIR', Safe::realpath($helperappsdir).GETID3_OS_DIRSLASH);
	...
	function analyze($filename) {
		...
		$this->info['filepath']            = str_replace('\\', '/', Safe::realpath(dirname($filename)));
