...
if(is_callable(array('Hooks', 'include_scripts')))
	$context['text'] .= Hooks::include_scripts('help.php#prefix');
...
if(Surfer::is_member()) {
	...
	$context['text'] .= sprintf(i18n::s('<p>If your browser supports side panels and javascript, click on the following link to %s.</p>'), '<a onclick="javascript:addSidePanel()">'.i18n::s('add a blogging panel').'</a>')."\n";
	...
	$context['text'] .= sprintf(i18n::s('<p>If your are running Internet Explorer under Windows, click on the following link to %s triggered on right-click. Accept registry updates, and restart the browser afterwards.</p>'), Skin::build_link('articles/ie_bookmarklet.php', i18n::s('add a contextual bookmarklet')))."\n";
...
if(is_callable(array('Hooks', 'include_scripts')))
	$context['text'] .= Hooks::include_scripts('help.php#suffix');

// last resort
$context['text'] .= Skin::build_block(i18n::s('Not satisfied yet?'), 'title')
	.'<ul>'
	.'<li>'.sprintf(i18n::s('%s on this site'), Skin::build_link('query.php', i18n::s('Submit a query to ask for help'))).'</li>'
