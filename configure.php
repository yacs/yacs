...
// save updated parameters
	...
	if(!Safe::file_put_contents('parameters/root.include.php', $content)) {
		...
		Skin::error(sprintf(i18n::s('ERROR: Impossible to write to the file %s. The configuration has not been saved.'), 'parameters/root.include.php'));
	...
	// job done
		...
		$description = $context['url_to_home'].$context['url_to_root'].'configure.php';
		Logger::remember('configure.php', $label, $description);
	}
