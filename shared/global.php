...
function render_skin($with_last_modified=TRUE) {
	...
	$context['page_header'] .= '<link rel="stylesheet" href="'.$context['url_to_root'].'included/browser/css/redmond/jquery-ui-1.10.3.custom.min.css" type="text/css" media="all" '.EOT."\n";
