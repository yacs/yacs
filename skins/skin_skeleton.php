...
//			$unit = 'k';
	...
	public static function build_referrals($script) {
        ...
        public static function build_select_editor() {
	...
	public static function initialize() {
		...
		if(!defined('PREVIOUS_IMG'))
			...
			define('PRIVATE_FLAG', tag::_span(
                                fa::_('low-vision','/private', (is_callable(array('i18n', 's')))? i18n::s('private') : 'private' )
                                ,'/flag'));
		...
		if(!defined('RESTRICTED_FLAG'))
			define('RESTRICTED_FLAG', tag::_span(
                                fa::_('low-vision','/restricted', (is_callable(array('i18n', 's')))? i18n::s('restricted') : 'restricted' )
                                ,'/flag'));
