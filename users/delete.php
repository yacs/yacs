...
$context['page_title'] = i18n::s('Delete a user');
...
// permission denied
	...
	if(!Surfer::is_logged())
		Safe::redirect($context['url_to_home'].$context['url_to_root'].'users/login.php?url='.urlencode(Users::get_url($item['id'], 'delete')));
