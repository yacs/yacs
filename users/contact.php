...
// process submitted data
	...
	$article['title'] = isset($_REQUEST['title']) ? $_REQUEST['title'] : utf8::transcode(Skin::build_date(gmdate('Y-m-d H:i:s GMT'), 'full'));
	$article['active_set'] = 'N';	// this is private
	$article['publish_date'] = gmdate('Y-m-d H:i:s'); // no review is required
