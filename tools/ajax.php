...
// // a JSON-RPC call
// $context['text'] .= '<p><a href="#" onclick="Yacs.call( { method: \'echo\', params: { message: \'hello world\' } }, function(s) { alert(s); } ); return false;" class="button"><span>JSON-RPC</span></a> - '.i18n::s('Click on the button to trigger the popup window').'</p>'."\n";
