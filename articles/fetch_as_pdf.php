...
// display the article
	...
	if(count($items))
		$context['text'] .= Skin::build_box(i18n::s('Related files'), Skin::build_list($items, 'compact'), 'section');
	...
	$context['text'] .= '<p>'.sprintf(i18n::s('The original page is located at %s'), Skin::build_link($context['url_to_home'].$context['url_to_root'].Articles::get_url($item['id'], 'view', $item['title']), $context['url_to_home'].$context['url_to_root'].Articles::get_url($item['id'], 'view', $item['title'])))."</p>\n";
