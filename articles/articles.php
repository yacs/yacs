...
Class Articles {
	...
	**/
	...
	public static function setup() {
		...
		$fields['behaviors']	= "TEXT DEFAULT '' NOT NULL";
		...
		$fields['description']	= "MEDIUMTEXT DEFAULT '' NOT NULL";
		...
		$fields['extra']		= "TEXT DEFAULT '' NOT NULL";
		...
		$fields['suffix']		= "TEXT DEFAULT '' NOT NULL";
		...
		$fields['trailer']		= "TEXT DEFAULT '' NOT NULL";
