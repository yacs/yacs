...
$_SESSION['l10n']['fr']['Allow anonymous surfers to use bottom tools as well (recommended on intranets)']='Autoriser les surfeurs anonymes &#224; utiliser les outils de bas de page (recommand&#233; sur les intranets)';
...
$_SESSION['l10n']['fr']['Bottom tools (pdf, palm, word, print) are used to export or to convert pages to an alternate format or media.']='Les outils de bas de page (PDF, Palm, Word, imprimer) sont utilis&#233;s pour exporter ou convertir les pages dans un format ou vers un m&#233;dia alternatif.';
$_SESSION['l10n']['fr']['Bottom tools are displayed only in sections with option \'with_bottom_tools\'']='Les outils de bas de page sont affich&#233;s seulement dans les sections avec l\'option \'with_bottom_tools\'';
$_SESSION['l10n']['fr']['Bottom tools are shown only to members']='Seuls les membres ont acc&#232;s aux outils de bas de page';
$_SESSION['l10n']['fr']['Bottom tools global control']='Contr&#244;le global des outils de bas de page';
$_SESSION['l10n']['fr']['Bottom tools visibility']='Visibilit&#233; des outils de bas de page';
...
$_SESSION['l10n']['fr']['Display bottom tools on all pages']='Afficher les outils de bas de page sur tous les articles';
