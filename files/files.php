...
Class Files {
	...
	**/
	...
	function setup() {
		...
		$fields['active']		= "ENUM('Y','R','N', 'X') DEFAULT 'Y' NOT NULL";			// Yes, Restricted, No, or eXternal
		$fields['active_set']	= "ENUM('Y','R','N') DEFAULT 'Y' NOT NULL"; 				// set locally
		$fields['alternate_href']	= "VARCHAR(255) DEFAULT '' NOT NULL";					// up to 255 chars
		...
		$fields['assign_name']	= "VARCHAR(128) DEFAULT '' NOT NULL";						// item creation
		...
		$fields['file_href']	= "VARCHAR(255) DEFAULT '' NOT NULL";						// up to 255 chars
		$fields['file_name']	= "VARCHAR(255) DEFAULT '' NOT NULL";						// up to 255 chars
		$fields['file_size']	= "INTEGER DEFAULT '0' NOT NULL";
		$fields['hits'] 		= "INT UNSIGNED DEFAULT '0' NOT NULL";						// counter
		$fields['icon_url'] 	= "VARCHAR(255) DEFAULT '' NOT NULL";						// up to 255 chars
		$fields['keywords'] 	= "TEXT NOT NULL";											// up to 64k chars
