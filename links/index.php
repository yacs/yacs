...
$stats = Links::stat();
if($stats['count'])
	$context['page_menu'] += array('_count' => sprintf(i18n::ns('%d link', '%d links', $stats['count']), $stats['count']));
...
// referrals, if any
$context['components']['referrals'] = Skin::build_referrals('links/index.php');
